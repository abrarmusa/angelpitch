...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { amount: @deck.amount, description: @deck.description, pitch: @deck.pitch, title: @deck.title }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { amount: @deck.amount, description: @deck.description, pitch: @deck.pitch, title: @deck.title }
    assert_redirected_to deck_path(assigns(:deck))
  end
